...
public class Authenticator extends Security.Authenticator {
    ...
    public Result onUnauthorized(Context context) {
        String next = context.request().uri();
        return redirect(controllers.routes.AdminController.login(next));
    }

    /**
     * NOTE: Wire this into your identity provider system
     * @param user
     * @param password
     * @return
     */
    public static boolean authenticate(String user, String password) {
        String adminPassword = ADMINS.get(user);
